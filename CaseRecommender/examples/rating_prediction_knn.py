...
from caserecc.recommenders.rating_prediction.user_attribute_knn import UserAttributeKNN
from caserecc.recommenders.rating_prediction.item_attribute_knn import ItemAttributeKNN
