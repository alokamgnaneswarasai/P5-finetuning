...
from caserecc.utils.extra_functions import check_error_file
...
class ReadFile(object):
    ...
    def read_with_pandas(self):
        ...
        # df = pd.read_csv(self.input_file, sep=self.sep, skiprows=self.header, header=None, names=self.names) # I have commented this line because it was not working
